...
class LdapPlugin(p.SingletonPlugin):
    ...
    def configure(self, main_config):
        ...
        schema = {
            ...
            'ckanext.ldap.organization.map': {'required_if': 'ckanext.ldap.organization.name', 'parse': p.toolkit.asbool},
            ...
            'ckanext.ldap.use_first': {'default': False, 'parse': p.toolkit.asbool},
        }
        errors = []
        for i in schema:
            v = None
