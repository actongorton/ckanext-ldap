...
class LdapUser(domain_object.DomainObject):
    ...
    def by_ldap_id(cls, ldap_id, autoflush=True):
        ...
        """
        obj = meta.Session.query(cls).autoflush(autoflush).filter_by(ldap_id=ldap_id).first()
        return obj
    ...
    def by_user_id(cls, user_id, autoflush=True):
        ...
        @return: LdapUser object or None
        """
        obj = meta.Session.query(cls).autoflush(autoflush).filter_by(user_id=user_id).first()
        return obj
